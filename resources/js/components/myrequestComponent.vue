            ...
            <div class="col-12">
                <div class="card border-sharp shadow-sm">
                    <div class="card-header bg-teal">
                        <h2 class="mb-0 pl-2 text-white">My Post Requests</h2>
                    </div>
                        ...
                        >
                            <div class="card border-sharp shadow-sm my-3">
                                ...
                                >
                                    <div class="col-auto">
                                        <img
                                            :src="getPostOwner(request).avatar"
                                    ...
                                    >
                                        ...
                                        >
                                            {{ getRequestPost(request).title }}
                                        </h5>
                                        <p class="text-muted mb-0">
                                            Posted by:
                                            {{ getPostOwner(request).name }}
                                        </p>
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        ...
        getPostOwner(request) {
            return this.postowners.find(
                postowner =>
                    postowner.id == this.getRequestPost(request).user_id
            );
        },
        getModule(request) {
            return this.modules.find(
                module => module.id == this.getRequestPost(request).module_id
            );
        }
    },
    computed: {
